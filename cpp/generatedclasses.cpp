...
public:
    ...
    static QVariant get_wrong(const Introspectable* i, int j) {
        return (static_cast<const DocInfoListSubContainerOrAtom*>(i)->wrong);
    }
};
...
public:
    ...
    static QVariant get_wrong(const Introspectable* i, int j) {
        return (static_cast<const TextSpecialInfoAtom*>(i)->wrong);
    }
};

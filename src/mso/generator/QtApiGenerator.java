...
public class QtApiGenerator {
	...
	public class QtApiConfiguration {
		...
		QtApiConfiguration(@Nullable String namespace, String basename,
				String outputdir) {
	...
	final public QtApiConfiguration config;

	final private String generatedWarning = "/* This code was generated by msoscheme (http://gitorious.org/msoscheme) */";

	public QtApiGenerator(@Nullable String namespace, String basename,
			String outputdir) {
		config = new QtApiConfiguration(namespace, basename, outputdir);
	}
